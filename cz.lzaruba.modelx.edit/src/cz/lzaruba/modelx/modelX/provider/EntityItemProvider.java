...
/**
 * This is the item provider adapter for a {@link cz.lzaruba.modelx.modelX.Entity} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EntityItemProvider extends ElementWithFeaturesItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ModelXPackage.Literals.ENTITY__SUPER_TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addInterfacesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Entity_interfaces_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Entity_interfaces_feature", "_UI_Entity_type"),
				 ModelXPackage.Literals.ENTITY__INTERFACES,
				 true,
				 false,
				 true,
				 null,
