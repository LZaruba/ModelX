...
/**
 * This is the item provider adapter for a {@link cz.lzaruba.modelx.modelX.Interface} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InterfaceItemProvider extends ElementWithFeaturesItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Interface_supertypes_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Interface_supertypes_feature", "_UI_Interface_type"),
				 ModelXPackage.Literals.INTERFACE__SUPER_TYPES,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ModelXPackage.Literals.INTERFACE__ANNOTATIONS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ModelXPackage.Literals.INTERFACE__ANNOTATIONS,
