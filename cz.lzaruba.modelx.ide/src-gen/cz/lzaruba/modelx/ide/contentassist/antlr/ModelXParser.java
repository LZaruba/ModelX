 ...
 */
package cz.lzaruba.modelx.ide.contentassist.antlr;

import com.google.inject.Inject;
import cz.lzaruba.modelx.ide.contentassist.antlr.internal.InternalModelXParser;
...
public class ModelXParser extends AbstractContentAssistParser {
	...
	@Override
	protected InternalModelXParser createParser() {
		InternalModelXParser result = new InternalModelXParser(null);
	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				...
				{
					put(grammarAccess.getElementWithFeaturesAccess().getAlternatives(), "rule__ElementWithFeatures__Alternatives");
					...
					put(grammarAccess.getInterfaceAccess().getGroup_4_2(), "rule__Interface__Group_4_2__0");
					...
					put(grammarAccess.getEntityAccess().getGroup_5_2(), "rule__Entity__Group_5_2__0");
					...
					put(grammarAccess.getInterfaceAccess().getSuperTypesAssignment_4_1(), "rule__Interface__SuperTypesAssignment_4_1");
					put(grammarAccess.getInterfaceAccess().getSuperTypesAssignment_4_2_1(), "rule__Interface__SuperTypesAssignment_4_2_1");
					put(grammarAccess.getInterfaceAccess().getFeaturesAssignment_6(), "rule__Interface__FeaturesAssignment_6");
					...
					put(grammarAccess.getDataTypeAccess().getCommentAssignment_0(), "rule__DataType__CommentAssignment_0");
					...
					put(grammarAccess.getPackageAccess().getCommentAssignment_0(), "rule__Package__CommentAssignment_0");
					put(grammarAccess.getPackageAccess().getNameAssignment_2(), "rule__Package__NameAssignment_2");
					put(grammarAccess.getPackageAccess().getImportsAssignment_4(), "rule__Package__ImportsAssignment_4");
					...
					put(grammarAccess.getEntityAccess().getAbstractAssignment_1(), "rule__Entity__AbstractAssignment_1");
					...
					put(grammarAccess.getEntityAccess().getInterfacesAssignment_5_1(), "rule__Entity__InterfacesAssignment_5_1");
					put(grammarAccess.getEntityAccess().getInterfacesAssignment_5_2_1(), "rule__Entity__InterfacesAssignment_5_2_1");
					...
					put(grammarAccess.getFeatureAccess().getRequiredAssignment_2(), "rule__Feature__RequiredAssignment_2");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			InternalModelXParser typedParser = (InternalModelXParser) parser;
	...
	public ModelXGrammarAccess getGrammarAccess() {
