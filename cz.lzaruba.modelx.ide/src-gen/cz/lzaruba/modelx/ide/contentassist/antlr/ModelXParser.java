		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getEntityAccess().getInterfacesAssignment_4_1(), "rule__Entity__InterfacesAssignment_4_1");
					put(grammarAccess.getEntityAccess().getInterfacesAssignment_4_2_1(), "rule__Entity__InterfacesAssignment_4_2_1");
