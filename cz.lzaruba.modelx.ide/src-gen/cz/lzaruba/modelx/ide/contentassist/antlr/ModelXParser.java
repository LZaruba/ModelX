		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getInterfaceAccess().getSupertypesAssignment_2_1(), "rule__Interface__SupertypesAssignment_2_1");
					put(grammarAccess.getInterfaceAccess().getFeaturesAssignment_4(), "rule__Interface__FeaturesAssignment_4");
					put(grammarAccess.getEnumAccess().getNameAssignment_0(), "rule__Enum__NameAssignment_0");
					put(grammarAccess.getEnumAccess().getLiteralsAssignment_2(), "rule__Enum__LiteralsAssignment_2");
					...
					put(grammarAccess.getEntityAccess().getInterfacesAssignment_3_1(), "rule__Entity__InterfacesAssignment_3_1");
					...
					put(grammarAccess.getFeatureAccess().getRequiredAssignment_1(), "rule__Feature__RequiredAssignment_1");
